...
@TeleOp(name = "TeleOpTeste1_RobotCentric", group = "TeleOp") // ROBOT-CENTRIC CHANGE: Renamed class for clarity
public class TeleOPTeste1 extends OpMode {
    ...
    public void init() {
        ...
        // Initialize the IMU
        // ROBOT-CENTRIC CHANGE: We no longer *need* the IMU for driving,
        // but we keep it for the telemetry yaw readout.
    ...
    public void start() {
        ...
        // This is still useful for telemetry.
        imu.resetYaw();
    }
    ...
    public void loop() {
        ...
        // CHANGE: Removed the negation to reverse rotation direction as requested by the user.
        ...
        //
        // ROBOT-CENTRIC CHANGE: Updated variable names in comment
        // robotForward *= movementSpeedScale;
        // robotStrafe *= movementSpeedScale;
        // robotRotate *= rotationSpeedScale;


        // 5. Call the ROBOT-CENTRIC drive function
        // ROBOT-CENTRIC CHANGE: We now call drive() directly,
        // skipping driveFieldRelative() entirely.
        ...
        // ROBOT-CENTRIC CHANGE: Updated telemetry labels
    ...
    public void driveFieldRelative(double forward, double strafe, double rotate) {
        // ROBOT-CENTRIC CHANGE: This function is no longer called from loop(),
        // but it is perfectly fine to leave it here for future use.
